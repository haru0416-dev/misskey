...
import { fetchBlockingByIdOrFailFromDatabase } from '@/core/BlockingStore.js';
...
export class BlockingEntityService {
	...
	public async pack(
		...
		const blocking = typeof src === 'object' ? src : await fetchBlockingByIdOrFailFromDatabase(this.drizzle, src);
