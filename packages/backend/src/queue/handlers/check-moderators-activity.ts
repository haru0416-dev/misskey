...
function generateModeratorInactivityMail(remainingTime: ModeratorInactivityRemainingTime) {
	...
	const message = [
		...
		'If you do not wish to move to invitation only, you must log into Toneriko and update your last active date and time.',
		'',
		'---------------',
		'',
		'To モデレーター各位',
		...
		'招待制に切り替わることを望まない場合は、Tonerikoにログインして最終アクティブ日時を更新してください。',
		'',
	];
