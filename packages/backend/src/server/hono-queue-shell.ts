 ...
 * を組み立てるが、現時点でこの関数が組み立てるのは8個 (userWebhookDeliver/systemWebhookDeliver/
 * relationship/postScheduledNote/system/deliver/endedPollNotification/objectStorage)。
 * **残り2個 (db/inbox) は未移植であり、本番のジョブキュー起動経路 (`boot/common.ts` の
