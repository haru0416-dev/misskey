...
import { addActivityContext, deliverNoteActivityForHonoApi, renderUpdateForHonoApi, type HonoApiNoteApDependencies } from './hono-api-notes-ap.js';
import { renderPersonForHonoApi, type HonoApiAccountUpdateDependencies } from './hono-api-account-update.js';
import { createRoleAssignedNotification, type HonoApiNotificationDependencies } from './hono-api-notification.js';
import type { HonoApiRolePolicyDependencies } from './hono-api-role-policy.js';
import { packMeDetailedForHonoApi, type MeDetailedHonoApiResponse, type UserPackingDependencies } from './hono-api-user.js';
import type { HonoApiFollowingDependencies } from './hono-api-following.js';
...
async function resolveMoveDestinationUserForHonoApi(deps: HonoApiAccountMoveDependencies, acct: string): Promise<MiUser> {
	...
	if (user == null) throw iMoveNoSuchUserError();
	return user;
}
