...
import { adminAbuseReportNotificationRecipientUpdateParamDef } from '@/server/rest/admin-abuse-report-notification-recipient.js';
...
export const paramDef = adminAbuseReportNotificationRecipientUpdateParamDef;
