...
import { adminAbuseReportNotificationRecipientCreateParamDef } from '@/server/rest/admin-abuse-report-notification-recipient.js';
...
export const paramDef = adminAbuseReportNotificationRecipientCreateParamDef;
