...
import { createPollEndedNotification, type HonoApiNotificationDependencies } from './hono-api-notification.js';
 ...
 */
export async function handleHonoQueueEndedPollNotification(deps: HonoQueueEndedPollNotificationDependencies, job: Bull.Job<EndedPollNotificationJobData>): Promise<void> {
