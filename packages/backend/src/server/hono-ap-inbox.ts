...
import { extractEmojisForHonoApi, updatePersonForHonoApi, type HonoApiApPersonDependencies } from './hono-api-ap-person.js';
import {
...
} from './hono-api-ap-note.js';
import { createNoteForHonoApi, type CreateNoteData } from './hono-api-notes-create.js';
import { deleteNoteForHonoApi, type HonoApiNotesDeleteDependencies } from './hono-api-notes-delete.js';
import { createNoteReactionForHonoApi, deleteNoteReactionForHonoApi, type HonoApiNotesReactionsDependencies } from './hono-api-notes-reactions.js';
import { isVisibleForMeForHonoApi, packNoteForHonoApi } from './hono-api-note.js';
import {
	blockForHonoApi,
	cancelFollowRequest,
...
import { followWithSideEffectsForHonoApi, type HonoQueueRelationshipDependencies } from './hono-queue-relationship.js';
import { acceptFollowRequestForHonoApi, type HonoApiFollowingDependencies } from './hono-api-following.js';
import { addPinnedForHonoApi, removePinnedForHonoApi, type HonoApiAccountPinDependencies } from './hono-api-account-pin.js';
import { isRelayActorForHonoApi, relayAcceptedForHonoApi, relayRejectedForHonoApi, type HonoApiAdminRelaysDependencies } from './hono-api-admin-relays.js';
import { reportAbuseForHonoApi, type HonoApiUsersReportAbuseDependencies } from './hono-api-admin-abuse-reports.js';
import type { HonoApiInternalEventPublisher, HonoApiNotesStreamPublisher, HonoApiNoteStreamPublisher } from './hono-api-events.js';
...
/** ApInboxService.performOneActivity 相当。 */
...
/** ApInboxService.acceptFollow 相当。 */
...
/** ApInboxService.announceNote 相当。 */
...
/** ApInboxService.rejectFollow 相当。 */
...
/** ApInboxService.undoAnnounce 相当。 */
