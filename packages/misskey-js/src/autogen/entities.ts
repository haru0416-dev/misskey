...
export type AdminQueueResumeRequest =
...
export type AdminQueueShowJobLogsRequest =
    operations['admin___queue___show-job-logs']['requestBody']['content']['application/json'];
...
export type AntennasRemoveNoteRequest =
    operations['antennas___remove-note']['requestBody']['content']['application/json'];
...
export type ChannelsMuteCreateRequest =
    operations['channels___mute___create']['requestBody']['content']['application/json'];
export type ChannelsMuteDeleteRequest =
    operations['channels___mute___delete']['requestBody']['content']['application/json'];
...
export type DriveFilesAttachedChatMessagesRequest =
    operations['drive___files___attached-chat-messages']['requestBody']['content']['application/json'];
...
export type DriveFilesMoveBulkRequest =
    operations['drive___files___move-bulk']['requestBody']['content']['application/json'];
...
export type NotesDraftsCreateRequest =
    operations['notes___drafts___create']['requestBody']['content']['application/json'];
export type NotesDraftsCreateResponse =
    operations['notes___drafts___create']['responses']['200']['content']['application/json'];
export type NotesDraftsDeleteRequest =
    operations['notes___drafts___delete']['requestBody']['content']['application/json'];
...
export type NotesDraftsUpdateRequest =
    operations['notes___drafts___update']['requestBody']['content']['application/json'];
...
export type NotesShowPartialBulkRequest =
    operations['notes___show-partial-bulk']['requestBody']['content']['application/json'];
...
export type NotificationsDeleteRequest =
    operations['notifications___delete']['requestBody']['content']['application/json'];
...
export type UsersGetFollowingUsersByBirthdayRequest =
    operations['users___get-following-users-by-birthday']['requestBody']['content']['application/json'];
