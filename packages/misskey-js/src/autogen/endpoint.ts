...
export type Endpoints = {
    ...
    'admin/ad/list': { req: AdminAdListRequest; res: AdminAdListResponse; reqOptional: true };
    ...
    'admin/captcha/current': { req: EmptyRequest; res: AdminCaptchaCurrentResponse; reqOptional: true };
    'admin/captcha/save': { req: AdminCaptchaSaveRequest; res: EmptyResponse };
    'admin/delete-account': { req: AdminDeleteAccountRequest; res: EmptyResponse };
    'admin/delete-all-files-of-a-user': { req: AdminDeleteAllFilesOfAUserRequest; res: EmptyResponse };
    'admin/drive/clean-remote-files': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'admin/drive/cleanup': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'admin/drive/files': { req: AdminDriveFilesRequest; res: AdminDriveFilesResponse; reqOptional: true };
    ...
    'admin/emoji/list': { req: AdminEmojiListRequest; res: AdminEmojiListResponse; reqOptional: true };
    ...
    'admin/get-index-stats': { req: EmptyRequest; res: AdminGetIndexStatsResponse; reqOptional: true };
    'admin/get-table-stats': { req: EmptyRequest; res: AdminGetTableStatsResponse; reqOptional: true };
    'admin/get-user-ips': { req: AdminGetUserIpsRequest; res: AdminGetUserIpsResponse };
    'admin/invite/create': { req: AdminInviteCreateRequest; res: AdminInviteCreateResponse; reqOptional: true };
    'admin/invite/list': { req: AdminInviteListRequest; res: AdminInviteListResponse; reqOptional: true };
    'admin/meta': { req: EmptyRequest; res: AdminMetaResponse; reqOptional: true };
    ...
    'admin/queue/deliver-delayed': { req: EmptyRequest; res: AdminQueueDeliverDelayedResponse; reqOptional: true };
    'admin/queue/inbox-delayed': { req: EmptyRequest; res: AdminQueueInboxDelayedResponse; reqOptional: true };
    ...
    'admin/queue/queues': { req: EmptyRequest; res: AdminQueueQueuesResponse; reqOptional: true };
    ...
    'admin/queue/stats': { req: EmptyRequest; res: AdminQueueStatsResponse; reqOptional: true };
    'admin/relays/add': { req: AdminRelaysAddRequest; res: AdminRelaysAddResponse };
    'admin/relays/list': { req: EmptyRequest; res: AdminRelaysListResponse; reqOptional: true };
    ...
    'admin/roles/list': { req: EmptyRequest; res: AdminRolesListResponse; reqOptional: true };
    ...
    'admin/server-info': { req: EmptyRequest; res: AdminServerInfoResponse; reqOptional: true };
    ...
    'admin/show-users': { req: AdminShowUsersRequest; res: AdminShowUsersResponse; reqOptional: true };
    ...
    'admin/update-meta': { req: AdminUpdateMetaRequest; res: EmptyResponse; reqOptional: true };
    ...
    'channels/featured': { req: EmptyRequest; res: ChannelsFeaturedResponse; reqOptional: true };
    'channels/follow': { req: ChannelsFollowRequest; res: EmptyResponse };
    'channels/followed': { req: ChannelsFollowedRequest; res: ChannelsFollowedResponse; reqOptional: true };
    ...
    'channels/mute/list': { req: EmptyRequest; res: ChannelsMuteListResponse; reqOptional: true };
    'channels/my-favorites': { req: EmptyRequest; res: ChannelsMyFavoritesResponse; reqOptional: true };
    'channels/owned': { req: ChannelsOwnedRequest; res: ChannelsOwnedResponse; reqOptional: true };
    ...
    'chat/history': { req: ChatHistoryRequest; res: ChatHistoryResponse; reqOptional: true };
    ...
    'chat/read-all': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    ...
    'chat/rooms/joining': { req: ChatRoomsJoiningRequest; res: ChatRoomsJoiningResponse; reqOptional: true };
    ...
    'chat/rooms/owned': { req: ChatRoomsOwnedRequest; res: ChatRoomsOwnedResponse; reqOptional: true };
    ...
    'clips/list': { req: ClipsListRequest; res: ClipsListResponse; reqOptional: true };
    'clips/my-favorites': { req: EmptyRequest; res: ClipsMyFavoritesResponse; reqOptional: true };
    ...
    drive: { req: EmptyRequest; res: DriveResponse; reqOptional: true };
    'drive/files': { req: DriveFilesRequest; res: DriveFilesResponse; reqOptional: true };
    ...
    'drive/folders': { req: DriveFoldersRequest; res: DriveFoldersResponse; reqOptional: true };
    'drive/folders/create': { req: DriveFoldersCreateRequest; res: DriveFoldersCreateResponse; reqOptional: true };
    ...
    'drive/stream': { req: DriveStreamRequest; res: DriveStreamResponse; reqOptional: true };
    'email-address/available': { req: EmailAddressAvailableRequest; res: EmailAddressAvailableResponse };
    emoji: { req: EmojiRequest; res: EmojiResponse };
    emojis: { req: EmptyRequest; res: EmojisResponse; reqOptional: true };
    endpoint: { req: EndpointRequest; res: EndpointResponse };
    endpoints: { req: EmptyRequest; res: EndpointsResponse; reqOptional: true };
    'export-custom-emojis': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    ...
    'federation/instances': { req: FederationInstancesRequest; res: FederationInstancesResponse; reqOptional: true };
    'federation/show-instance': { req: FederationShowInstanceRequest; res: FederationShowInstanceResponse };
    'federation/stats': { req: FederationStatsRequest; res: FederationStatsResponse; reqOptional: true };
    ...
    'flash/featured': { req: FlashFeaturedRequest; res: FlashFeaturedResponse; reqOptional: true };
    'flash/like': { req: FlashLikeRequest; res: EmptyResponse };
    'flash/my': { req: FlashMyRequest; res: FlashMyResponse; reqOptional: true };
    'flash/my-likes': { req: FlashMyLikesRequest; res: FlashMyLikesResponse; reqOptional: true };
    ...
    'following/list': { req: FollowingListRequest; res: FollowingListResponse; reqOptional: true };
    ...
    'following/update-all': { req: FollowingUpdateAllRequest; res: EmptyResponse; reqOptional: true };
    'gallery/featured': { req: GalleryFeaturedRequest; res: GalleryFeaturedResponse; reqOptional: true };
    'gallery/popular': { req: EmptyRequest; res: GalleryPopularResponse; reqOptional: true };
    'gallery/posts': { req: GalleryPostsRequest; res: GalleryPostsResponse; reqOptional: true };
    ...
    'get-avatar-decorations': { req: EmptyRequest; res: GetAvatarDecorationsResponse; reqOptional: true };
    'get-online-users-count': { req: EmptyRequest; res: GetOnlineUsersCountResponse; reqOptional: true };
    ...
    'hashtags/trend': { req: EmptyRequest; res: HashtagsTrendResponse; reqOptional: true };
    'hashtags/users': { req: HashtagsUsersRequest; res: HashtagsUsersResponse };
    i: { req: EmptyRequest; res: IResponse; reqOptional: true };
    ...
    'i/export-antennas': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-blocking': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-clips': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-favorites': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-following': { req: IExportFollowingRequest; res: EmptyResponse; reqOptional: true };
    'i/export-mute': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-notes': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/export-user-lists': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'i/favorites': { req: IFavoritesRequest; res: IFavoritesResponse; reqOptional: true };
    'i/gallery/likes': { req: IGalleryLikesRequest; res: IGalleryLikesResponse; reqOptional: true };
    'i/gallery/posts': { req: IGalleryPostsRequest; res: IGalleryPostsResponse; reqOptional: true };
    ...
    'i/notifications': { req: INotificationsRequest; res: INotificationsResponse; reqOptional: true };
    'i/notifications-grouped': {
        req: INotificationsGroupedRequest;
        res: INotificationsGroupedResponse;
        reqOptional: true;
    };
    'i/page-likes': { req: IPageLikesRequest; res: IPageLikesResponse; reqOptional: true };
    'i/pages': { req: IPagesRequest; res: IPagesResponse; reqOptional: true };
    ...
    'i/registry/get-all': { req: IRegistryGetAllRequest; res: IRegistryGetAllResponse; reqOptional: true };
    'i/registry/get-detail': { req: IRegistryGetDetailRequest; res: IRegistryGetDetailResponse };
    'i/registry/keys': { req: IRegistryKeysRequest; res: IRegistryKeysResponse; reqOptional: true };
    ...
    'i/registry/scopes-with-domain': { req: EmptyRequest; res: IRegistryScopesWithDomainResponse; reqOptional: true };
    'i/registry/set': { req: IRegistrySetRequest; res: EmptyResponse };
    'i/revoke-token': { req: IRevokeTokenRequest; res: EmptyResponse };
    'i/signin-history': { req: ISigninHistoryRequest; res: ISigninHistoryResponse; reqOptional: true };
    'i/unpin': { req: IUnpinRequest; res: IUnpinResponse };
    'i/update': { req: IUpdateRequest; res: IUpdateResponse; reqOptional: true };
    ...
    'i/webhooks/list': { req: EmptyRequest; res: IWebhooksListResponse; reqOptional: true };
    ...
    'invite/create': { req: EmptyRequest; res: InviteCreateResponse; reqOptional: true };
    'invite/delete': { req: InviteDeleteRequest; res: EmptyResponse };
    'invite/limit': { req: EmptyRequest; res: InviteLimitResponse; reqOptional: true };
    'invite/list': { req: InviteListRequest; res: InviteListResponse; reqOptional: true };
    meta: { req: MetaRequest; res: MetaResponse; reqOptional: true };
    ...
    'notes/drafts/count': { req: EmptyRequest; res: NotesDraftsCountResponse; reqOptional: true };
    'notes/drafts/create': { req: NotesDraftsCreateRequest; res: NotesDraftsCreateResponse; reqOptional: true };
    'notes/drafts/delete': { req: NotesDraftsDeleteRequest; res: EmptyResponse };
    'notes/drafts/list': { req: NotesDraftsListRequest; res: NotesDraftsListResponse; reqOptional: true };
    'notes/drafts/update': { req: NotesDraftsUpdateRequest; res: NotesDraftsUpdateResponse };
    'notes/favorites/create': { req: NotesFavoritesCreateRequest; res: EmptyResponse };
    'notes/favorites/delete': { req: NotesFavoritesDeleteRequest; res: EmptyResponse };
    'notes/featured': { req: NotesFeaturedRequest; res: NotesFeaturedResponse; reqOptional: true };
    'notes/global-timeline': { req: NotesGlobalTimelineRequest; res: NotesGlobalTimelineResponse; reqOptional: true };
    'notes/hybrid-timeline': { req: NotesHybridTimelineRequest; res: NotesHybridTimelineResponse; reqOptional: true };
    'notes/local-timeline': { req: NotesLocalTimelineRequest; res: NotesLocalTimelineResponse; reqOptional: true };
    'notes/mentions': { req: NotesMentionsRequest; res: NotesMentionsResponse; reqOptional: true };
    ...
    'notes/timeline': { req: NotesTimelineRequest; res: NotesTimelineResponse; reqOptional: true };
    ...
    'notifications/flush': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'notifications/mark-all-as-read': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'notifications/test-notification': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    ...
    'pages/featured': { req: EmptyRequest; res: PagesFeaturedResponse; reqOptional: true };
    ...
    ping: { req: EmptyRequest; res: PingResponse; reqOptional: true };
    'pinned-users': { req: EmptyRequest; res: PinnedUsersResponse; reqOptional: true };
    ...
    'renote-mute/list': { req: RenoteMuteListRequest; res: RenoteMuteListResponse; reqOptional: true };
    'request-reset-password': { req: RequestResetPasswordRequest; res: EmptyResponse };
    'reset-db': { req: EmptyRequest; res: EmptyResponse; reqOptional: true };
    'reset-password': { req: ResetPasswordRequest; res: EmptyResponse };
    retention: { req: EmptyRequest; res: RetentionResponse; reqOptional: true };
    'roles/list': { req: EmptyRequest; res: RolesListResponse; reqOptional: true };
    ...
    'server-info': { req: EmptyRequest; res: ServerInfoResponse; reqOptional: true };
    stats: { req: EmptyRequest; res: StatsResponse; reqOptional: true };
    ...
    users: { req: UsersRequest; res: UsersResponse; reqOptional: true };
    ...
    'users/lists/list': { req: UsersListsListRequest; res: UsersListsListResponse; reqOptional: true };
    ...
    'users/recommendation': { req: UsersRecommendationRequest; res: UsersRecommendationResponse; reqOptional: true };
    ...
    'v2/admin/emoji/list': { req: V2AdminEmojiListRequest; res: V2AdminEmojiListResponse; reqOptional: true };
