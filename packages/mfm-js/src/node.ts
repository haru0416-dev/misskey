...
export const PLAIN = (text: string): NodeType<'plain'> => {
	return { type: 'plain', children: [TEXT(text)] };
};
...
export type NodeType<T extends MfmNode['type']> = T extends 'quote'
	? MfmQuote
	: T extends 'search'
		? MfmSearch
		: T extends 'blockCode'
							...
							: T extends 'bold'
								...
								: T extends 'small'
									...
									: T extends 'italic'
										...
										: T extends 'strike'
											? MfmStrike
											: T extends 'inlineCode'
												? MfmInlineCode
												: T extends 'mathInline'
													? MfmMathInline
													: T extends 'mention'
														? MfmMention
														: T extends 'hashtag'
