...
export type SeqParseResult<T extends unknown[]> = T extends []
	? []
	: T extends [infer F, ...infer R]
		? F extends Parser<unknown>
			? [ParsedType<F>, ...SeqParseResult<R>]
			: [unknown, ...SeqParseResult<R>]
		: unknown[];
...
export type ParserTable<T> = { [K in keyof T]: Parser<T[K]> };
