...
<SearchMarker path="/settings/notifications" :label="i18n.ts.notifications" :keywords="['notifications']" icon="ti ti-bell">
	<div class="_gaps_m">
		<MkFeatureBanner icon="/fluent-emoji/1f514.png" color="#ffbf00">
...
import XNotificationConfig from './notification-config.vue';
import type { NotificationConfig } from './notification-config.vue';
