...
import XGridLocalComponent from '@/pages/admin/custom-emojis-manager2/local/list/index.vue';
import XGridRemoteComponent from '@/pages/admin/custom-emojis-manager2/remote.vue';
import XRegisterComponent from '@/pages/admin/custom-emojis-manager2/register.vue';
