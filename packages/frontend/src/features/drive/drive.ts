...
export function chooseDriveFile(
	...
	return new Promise((resolve, rej) => {
		...
		os.popupAsyncWithDialog(
			import('@/features/drive/components/MkDriveFileSelectDialog.vue').then((x) => x.default),
			{
...
> {
	return new Promise((resolve, reject) => {
		let dispose: () => void;
		os.popupAsyncWithDialog(
			import('@/features/drive/components/MkDriveFolderSelectDialog.vue').then((x) => x.default),
			{
				initialFolder,
			},
			{
