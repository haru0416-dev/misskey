...
<div class="_panel" :class="$style.root">
	<div :class="$style.banner" :style="user.bannerUrl ? { backgroundImage: `url(${prefer.disableShowingAnimatedImages ? getStaticImageUrl(user.bannerUrl) : user.bannerUrl})` } : ''"></div>
