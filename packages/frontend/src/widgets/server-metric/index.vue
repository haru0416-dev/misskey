...
<MkContainer :showHeader="widgetProps.showHeader" :naked="widgetProps.transparent">
	...
	<template #func="{ buttonStyleClass }"><button v-tooltip="i18n.ts.switch" class="_button" :class="buttonStyleClass" :aria-label="i18n.ts.switch" @click="toggleView()"><i class="ti ti-selector" aria-hidden="true"></i></button></template>
